...
namespace Demolisher
{
    public static class Keywords
    {
        ...
        public const string SharpnessNameRu = "Острота";
        ...
        public const string MediumMeleeAttackNameRu = "Изрез Мечом";
        public const string FireGrenadeName = "Fire Grenade";
        public const string FireGrenadeNameRu = "Выстрел Гранатой";
        public const string ShieldChargeName = "Charge";
        public const string ShieldChargeNameRu = "Рывок";
        public const string WhirlwindMeleeName = "Whirlwind";
        public const string WhirlwindMeleeNameRu = "Вихрь";
        public const string CollapseName = "Collapse";
        public const string CollapseNameRu = "Коллапс";
        public const string FireTallSwordName = "Ground Slice";
        public const string FireTallSwordNameRu = "Прорез Земли";
        public const string ParryName = "Cross Stich";
        public const string ParryNameRu = "Перекрести Клинки";
        public const string SlicingName = "Slicing Flow";
        public const string SlicingNameRu = "Режущий Поток";
        public const string SlamName = "Dark Descent";
        public const string SlamNameRu = "Темное Приземление";
        public const string ChainDashName = "Chain Dash";
        public const string ChainDashNameRu = "Цепной Уклон";
        public const string FlyName = "Devil Parcel";
        public const string FlyNameRu = "Дьявольская Посылка";
        public const string LaserName = "Pressure";
        public const string LaserNameRu = "Давление";
        ...
        public const string EffectCoefficientName = "Effect Coefficient";
